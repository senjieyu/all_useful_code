...
Usage:
  python lmp2vasp.py <input_dir> <output_dir> --elements Cu Ni ...
"""
...
def main():
    parser = argparse.ArgumentParser(description="Batch convert LAMMPS .lmp files to VASP .vasp files.")
    parser.add_argument("input_dir", type=str, help="Input directory containing .lmp files")
