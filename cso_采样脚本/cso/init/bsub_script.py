...
'''train_sus_exe'''
sus2_mlp_exe = '/work/phy-luoyf/apps/SUS2-MLIP/bin/mlp-sus2'
...
lmp_cores = 40
lmp_ptile = 40
lmp_exe = 'mpirun -machinefile $LSB_DJOB_HOSTFILE -np $NP /work/phy-luoyf/apps/lammps_sus2/interface-lammps-mlip-2/lmp_intel_cpu_intelmpi'

scf_queue = 33
scf_cores = 40
scf_ptile = 40
scf_cal_engine = 'vasp'       # abacus,vasp and cp2k
